...
The Win32 Console system provides simple input/output. Determining the number of digits in a number entered from the keyboard.
...
Платформа Windows. Простой ввод-вывод. Определения количества цифр в числе, введённом с клавиатуры.
